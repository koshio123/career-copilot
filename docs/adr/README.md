...
| [0012](0012-ats-vendor-support.md) | ATS vendor support and priority | Accepted |
| [0013](0013-fetch-etiquette-robots-and-tos.md) | Fetch etiquette: robots.txt, rate limits, and ToS | Accepted |
